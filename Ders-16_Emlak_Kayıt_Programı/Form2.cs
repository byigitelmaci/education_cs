...
namespace Ders_16_Emlak_Kayıt_Programı
{
    public partial class Form2 : Form
    {
        ...
        {
            baglan.Open();
            SqlCommand komut = new SqlCommand("update sitebilgi set id ='" + textBox7.Text.ToString() + "',site='" + comboBox1.Text.ToString() + "',odasayısı='" + comboBox3.Text.ToString() + "',metrekare='" + textBox1.Text.ToString() + "',fiyat='" + textBox2.Text.ToString() + "',blok='" + comboBox4.Text.ToString() + "',no='" + textBox3.Text.ToString() + "',adsoyad='" + textBox5.Text.ToString() + "',telefon='" + textBox4.Text.ToString() + "',notlar='" + textBox6.Text.ToString() + "',satkiralik='" + comboBox2.Text.ToString() + "'where id =" + id + "", baglan);
            komut.ExecuteNonQuery();
            baglan.Close();
            verilerimigöster();
